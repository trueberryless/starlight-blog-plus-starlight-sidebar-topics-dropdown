...
function getTopicFromSlug(config: StarlightSidebarTopicsDropdownSharedConfig, sidebar: SidebarEntry[], slug: string): Topic | undefined {
...
function getTopicById(config: StarlightSidebarTopicsDropdownSharedConfig, sidebar: SidebarEntry[], id: string): Topic | undefined {
  let topicConfig: Topic["config"] | undefined;
  let topicSidebar: Topic["sidebar"] | undefined;
  let groupTopicIndex = -1;
  for (const topic of config) {
